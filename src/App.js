  ...
  return (
    <Layout>
      ...
      <button
        ...
        className="bg-red-200 text-red-600 font-semibold hover:bg-red-200 duration-100 hover:text-purple-800 rounded-md px-2 py-1 shadow-2xl"
      >
        Logout
      </button>
      ...
      <div className="text-center my-5">
        <button
          className="bg-purple-300 text-purple-600 font-normal hover:bg-purple-200 duration-100 hover:text-purple-800 rounded-md px-2 py-1 shadow-2xl"
          onClick={() => history.push("/expense/new")}
        >
          Add Expense
        </button>
      </div>
